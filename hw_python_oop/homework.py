...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        kcal_coeff_1 = 0.035
        kcal_coeff_2 = 0.029
        return ((kcal_coeff_1 * self.weight
                + (Training.get_mean_speed(self) ** 2 // self.weight)
                * kcal_coeff_2 * self.height) * (self.duration
                * Training.MIN_IN_HOUR))
...
class Swimming(Training):
    ...
    def get_spent_calories(self) -> float:
        kcal_coeff_1 = 1.1
        kcal_coeff_2 = 2
        return ((self.get_mean_speed() + kcal_coeff_1)
                * kcal_coeff_2 * self.weight)
